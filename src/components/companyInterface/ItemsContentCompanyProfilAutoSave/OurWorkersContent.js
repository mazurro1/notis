...
import { fetchAddWorkerToCompany, changeActiveWorker } from "@state/actions"
...
const OurWorkersContent = ({
  ...
  const handleEditWorkers = () => {
    scroller.scrollTo("workersScrollElement", {
      duration: 100,
      smooth: true,
      offset: -100,
    })
  ...
  return (
    <Element name="workersScrollElement" className="element">
      <PositionRelative
        siteProps={siteProps}
